...
Deployed here:
https://repro-v-if-bug-85xpxq7h9.now.sh
Can also send and id parameter to deployment:
https://repro-v-if-bug-85xpxq7h9.now.sh/?id=ok
CodeSandbox:
https://codesandbox.io/s/github/iiAku/repro-v-if-bug
